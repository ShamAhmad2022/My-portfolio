...
export const homeProjectsThumbnails = [
  {
    name: "Virtual-Interviewer-and-Virtual-Conversationalist.1.0.0",
    thumbnail: "https://raw.githubusercontent.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/main/public/Gallery/Home.png",
    url: "https://virtual-interviewer-virtual-conversationalist.vercel.app"
  },
  {
    name: "Shat.1.0.1",
...
export const filterTags = ["all", "ReactJs", "NextJs", "NodeJs", "PostgresQl", "game"];

export const projectsPageProjects = [
  {
    name: "Virtual-Interviewer-and-Virtual-Conversationalist.1.0.0",
    date: "May 2024",
    desciption: 'A web app to help you Improve your interview skills and English speaking effortlessly with practice sessions tailored for interviews and conversations.',
    details: "<img src='https://res.cloudinary.com/dd4yn2x48/image/upload/fl_preserve_transparency/v1715538237/favicon_v1lzp1.jpg?_s=public-app' alt='logo' class='mb-16 xl:mb-8'><h2 class='mb-3 text-4xl font-bold'>Virtual Intreviewer:</h2><p class='my-3'>Choose a position, listen to each question, and then provide your answer. You can change the order of the questions and specify where to start and end</p><h3 class='mb-3 text-xl font-bold'>Features:</h3><li>multiple positions</li><li>show intreview questions</li><li>choose from where to start</li><li>choose from where to end</li><li>shuffle questions</li><li>reset questions</li><li>change the intreviewer voice (male or female)</li><li>show or hide your answer</li><li>restart the intreview</li><h4 class='my-3 text-xl font-bold'>coming Features:</h4><li>let the user add their own positions and questions</li><li>design improvements</li><li>use more advanced speech api</li><h2 class='mt-10 mb-3 text-4xl font-bold''>Virtual Conversationalist:</h2><p class='my-3'>Choose a conversation and read your part. Once you've finished, you can restart the conversation or select a new one</p><h3 class='mb-3 text-xl font-bold'>Features:</h3><li>multiple conversation topics</li><li>show the conversation</li><li>change the conversationalist voice (male or female)</li><li>restart the conversation</li><h4 class='my-3 text-xl font-bold'>coming Features:</h4><li>let the user add their conversation</li><li>design improvements</li><li>use more advanced speech api</li>",
    tags: ["NextJs", "Tailwind CSS", "Web speech API"],
    notes: ["This web app is still not compatible on all browsers, for now it only works as expected on desktop Google Chrome and Microsoft Edge.", "The purpose of this web app is for practice. The Virtual Interviewer won't correct your answers if they are wrong."],
    thumbnail: "https://raw.githubusercontent.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/main/public/Gallery/Home.png",
    liveUrl: "https://virtual-interviewer-virtual-conversationalist.vercel.app",
    GithubUrl: "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist",
    videoUrl: "https://drive.google.com/file/d/1hDwsrhxYrr6pxnmrnAcEZ3_mcK2ZD96Y/view",
    images: ["https://raw.githubusercontent.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/main/public/Gallery/Home.png", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VI1.png", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VI2.png", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VC1.png", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VC2.png", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/Homemob.jpg", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VI1mob.jpg", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VI2mob.jpg", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VC1mob.jpg", "https://github.com/ShamAhmad2022/Virtual-Interviewer-Virtual-Conversationalist/raw/main/public/Gallery/VC2mob.jpg"]
  },
  {
    name: "Shat.1.0.1",
    date: "Feb 2024",
    desciption: 'Shat is a web-based app that allows users to connect, chat, and edit their profiles.',
    details: "<img src='https://github.com/SHAT-2024/SHAT/raw/main/src/Assets/shat-logo.png' alt='logo' class='mb-16 xl:mb-8'><h2 class='mb-3 text-xl font-bold'>Features:</h2><li>Users can create an account</li><li>Users can edit their profile information</li><li>Users can search for other users</li><li>Users can view other users information</li><li>Users can chat with each other</li><li>Users can delete conversations</li><li>Users can edit any sent message in a conversation</li><li>Users can delete any sent message in a conversation</li><li>Real time chatting</li><li>Typing indicator</li><h3 class='mb-3 mt-8 text-xl font-bold'>coming Features:</h3><li>sending media and voice records</li><li>deleting other users messages in a conversation</li><li>notification when receiving a new message</li><li>message read indicators</li><li>new and unread messages badge</li><li>voice and video calls</li><li>group chats</li><li>block users</li><li>adding a chat bot</li>",
    tags: ["ReactJs", "NodeJs", "ExpressJs", "PostgresQl", "personal", "SCSS", "Reducers", "Context API", "Spline"],
    notes: ["I used 3D design software Spline to make the 3D mobile asset in the landing page"],
    thumbnail: "https://raw.githubusercontent.com/SHAT-2024/SHAT/main/src/Assets/homepage.png",
  ...
  },
  {
    ...
    name: "Questions-Game",
    date: "Nov 2023",
    desciption: 'A simple game I made for a ninth-grade computer science project. In the game, a student spins a wheel to select a question, each of which is represented by a specific color. After the question is revealed, the student who spun the wheel listens to their classmates\' answers. They can then indicate whether the answer is true or false by clicking on the corresponding buttons. This process continues until all questions have been answered. Finally, upon completing all questions, a congratulatory message pops up.',
    details: "",
