...
function EachProject({ project, index }) {
    ...
    return (
        <motion.div className='rounded-lg relative group' variants={eachProjectAnimationVariants} initial="initial" whileInView="animate" viewport={{once: true}} custom={index}>
